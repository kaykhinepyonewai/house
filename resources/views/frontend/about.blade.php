...
<h1 class="form1 text-center" >Admin</h1>
<hr class="divider1" > 
<div class="container-fluid my-5">
  <div class="row">
    ...
    <div class="col-md-3 justify-content-center pr-5 text-info font-weight-bold" style="line-height: 50px;">
...
<h2 class="text-center text-info">Reasons Why Renting Could Be Better Than Buying</h2>
<div class="container-fluid my-5">
  <div class="row">
    <div class="col-md-6">
     ...
     <div class="col-md-6">
      <ul class="text-info text-capitalize" style="line-height: 45px; font-size: 20px">
