...
class OwnerWaitingController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        // dd($properties);
       return view('frontend.ownerwaitings.index',compact('properties'));
    ...
    public function edit($id)
    {
        ...
        return view('frontend.ownerwaitings.edit',compact('property','categories','townships'));
    }
    ...
    public function update(Request $request, $id)
    {
       ...
       //First photo
        ...
        // Redirect
        return redirect()->route('ownerwaitings.index');
    }
